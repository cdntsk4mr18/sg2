...
<span style="visibility:hidden;" id="hidden"><?php echo htmlentities($_SESSION['user']['username'], ENT_QUOTES, 'UTF-8'); ?></span>
    <a class="btn btn-large btn btn-info" href="students.php">Students</a>
    <a class="btn btn-large btn btn-danger" href="sg.php">SG</a>
    <a class="btn btn-large btn btn btn-warning" href="department.php">Department</a>
</div>
